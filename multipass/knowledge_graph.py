"""
knowledge_graph.py — Temporal Entity-Relationship Graph for multipass
=====================================================================
...
Real knowledge graph with:
  ...
  - Locker references (links back to the verbatim memory)
...
Usage:
    from multipass.knowledge_graph import KnowledgeGraph
...
DEFAULT_KG_PATH = os.path.expanduser("~/.multipass/knowledge_graph.sqlite3")
...
class KnowledgeGraph:
    ...
    def add_triple(
        ...
        conn.execute(
            """INSERT INTO triples (id, subject, predicate, object, valid_from, valid_to, confidence, source_locker, source_file)
               VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)""",
            (
                triple_id,
                sub_id,
