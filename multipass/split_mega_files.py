...
# Loaded from ~/.multipass/known_names.json if it exists, otherwise generic fallback.
_KNOWN_NAMES_PATH = HOME / ".multipass" / "known_names.json"
...
def extract_people(lines):
    ...
    if dir_match:
        ...
        # User can map usernames to names in ~/.multipass/known_names.json
