...
Used by multipass init before mining begins.
...
def extract_candidates(text: str) -> dict:
    ...
    # Also find multi-word proper nouns (e.g. "Memory Ship", "Claude Code")
...
def confirm_entities(detected: dict, yes: bool = False) -> dict:
    ...
    """
    print(f"\n{'=' * 58}")
    print("  multipass — Entity Detection")
    print(f"{'=' * 58}")
