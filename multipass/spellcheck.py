#!/usr/bin/env python3
"""
spellcheck.py — Spell-correct user messages before ship filing.
...
Usage:
    from multipass.spellcheck import spellcheck_user_text
...
if __name__ == "__main__":
    ...
    for msg in test_cases:
        result = spellcheck_user_text(msg, known_names={"riley", "sam", "multipass"})
